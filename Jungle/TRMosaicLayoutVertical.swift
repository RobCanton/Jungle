...
public protocol TRMosaicLayoutVerticalDelegate {
...
open class TRMosaicLayoutVertical: UICollectionViewLayout {
    
    open var delegate:TRMosaicLayoutVerticalDelegate!
...
extension TRMosaicLayoutVertical {
